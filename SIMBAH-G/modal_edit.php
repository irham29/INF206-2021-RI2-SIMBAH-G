      ...
      <div class="modal-body">
        ...
        <div class="form-group">
          ...
          <label class="col-sm-3 control-label text-right font-weight-bold">Kategori</label>
            <div class="col-sm-8">
              <select name="edit_kategori" class="form-control select2" style="width: 100 %;">
        ...
        <div class="form-group">
          <div class="row">
            ...
            <div class="col-sm-8">
              <input type="text" class="form-control" name="edit_nama" value="<?php echo $barang['nama']; ?>">
            </div>
          </div>
        </div>
        ...
        <div class="form-group">
          <div class="row">
            ...
            <div class="col-sm-8">
              <input type="number" class="form-control" name="edit_target" value="<?php echo $barang['target']; ?>">
            </div>
          </div>
        </div>
        ...
        <div class="form-group">
          <div class="row">
            ...
            <div class="col-sm-8">
              <input disabled type="number" class="form-control" name="edit_tercapai" value="<?php echo $barang['tercapai']; ?>">
            </div>
          </div>
        </div>
